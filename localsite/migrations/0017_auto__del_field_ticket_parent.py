...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Ticket.parent'
        db.delete_column('localsite_ticket', 'parent_id')


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Ticket.parent'
        raise RuntimeError("Cannot reverse this migration. 'Ticket.parent' and its values cannot be restored.")
