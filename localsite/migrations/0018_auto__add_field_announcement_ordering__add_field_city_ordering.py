...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('localsite_announcement', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'City.ordering'
        db.add_column('localsite_city', 'ordering', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Announcement.ordering'
        db.delete_column('localsite_announcement', 'ordering')

        # Deleting field 'City.ordering'
        db.delete_column('localsite_city', 'ordering')


    models = {
        'localsite.announcement': {
            'Meta': {'ordering': "['ordering', 'from_date']", 'object_name': 'Announcement'},
