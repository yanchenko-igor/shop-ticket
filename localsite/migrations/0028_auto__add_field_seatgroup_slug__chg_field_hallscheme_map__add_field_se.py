...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'SeatGroup.slug'
        db.add_column('localsite_seatgroup', 'slug', self.gf('django.db.models.fields.SlugField')(db_index=True, default='', max_length=50, blank=True), keep_default=False)

        # Changing field 'HallScheme.map'
        db.alter_column('localsite_hallscheme', 'map', self.gf('django.db.models.fields.TextField')(null=True))

        # Adding field 'SeatSection.slug'
        db.add_column('localsite_seatsection', 'slug', self.gf('django.db.models.fields.SlugField')(db_index=True, default='', max_length=50, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'SeatGroup.slug'
        db.delete_column('localsite_seatgroup', 'slug')

        # Changing field 'HallScheme.map'
        db.alter_column('localsite_hallscheme', 'map', self.gf('django.db.models.fields.TextField')(default=''))

        # Deleting field 'SeatSection.slug'
        db.delete_column('localsite_seatsection', 'slug')
