...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SeatGroupPrice.price'
        db.alter_column('localsite_seatgroupprice', 'price', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'SeatGroupPrice.price'
        db.alter_column('localsite_seatgroupprice', 'price', self.gf('django.db.models.fields.IntegerField')(default=''))
