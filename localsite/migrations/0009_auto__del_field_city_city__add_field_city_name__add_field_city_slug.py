...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('localsite_city', 'city')

        # Adding field 'City.name'
        db.add_column('localsite_city', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=25), keep_default=False)

        # Adding field 'City.slug'
        db.add_column('localsite_city', 'slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=25, db_index=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'City.city'
        db.add_column('localsite_city', 'city', self.gf('django.db.models.fields.CharField')(default='', max_length=25), keep_default=False)

        # Deleting field 'City.name'
        db.delete_column('localsite_city', 'name')

        # Deleting field 'City.slug'
        db.delete_column('localsite_city', 'slug')
