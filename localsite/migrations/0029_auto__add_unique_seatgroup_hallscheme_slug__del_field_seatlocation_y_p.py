...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'SeatGroup', fields ['hallscheme', 'slug']
        db.create_unique('localsite_seatgroup', ['hallscheme_id', 'slug'])

        # Deleting field 'SeatLocation.y_position'
        db.delete_column('localsite_seatlocation', 'y_position')

        # Deleting field 'SeatLocation.x_position'
        db.delete_column('localsite_seatlocation', 'x_position')


    def backwards(self, orm):
        
        # Removing unique constraint on 'SeatGroup', fields ['hallscheme', 'slug']
        db.delete_unique('localsite_seatgroup', ['hallscheme_id', 'slug'])

        # Adding field 'SeatLocation.y_position'
        db.add_column('localsite_seatlocation', 'y_position', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'SeatLocation.x_position'
        db.add_column('localsite_seatlocation', 'x_position', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
