...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('localsite_seatgroup', 'hallscheme', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='seatgroups', to=orm['localsite.HallScheme']), keep_default=False)
