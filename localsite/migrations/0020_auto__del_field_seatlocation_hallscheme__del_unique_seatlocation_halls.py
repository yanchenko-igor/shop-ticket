...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'SeatLocation', fields ['group', 'col', 'row']
        db.create_unique('localsite_seatlocation', ['group_id', 'col', 'row'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SeatLocation', fields ['group', 'col', 'row']
        db.delete_unique('localsite_seatlocation', ['group_id', 'col', 'row'])

        # User chose to not deal with backwards NULL issues for 'SeatLocation.hallscheme'
        raise RuntimeError("Cannot reverse this migration. 'SeatLocation.hallscheme' and its values cannot be restored.")
