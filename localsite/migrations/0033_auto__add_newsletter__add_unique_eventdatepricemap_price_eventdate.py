...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('localsite_newsletter', (
        ...
        db.send_create_signal('localsite', ['Newsletter'])

        # Adding unique constraint on 'EventDatePriceMap', fields ['price', 'eventdate']
        db.create_unique('localsite_eventdatepricemap', ['price', 'eventdate_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'EventDatePriceMap', fields ['price', 'eventdate']
        db.delete_unique('localsite_eventdatepricemap', ['price', 'eventdate_id'])

        # Deleting model 'Newsletter'
        db.delete_table('localsite_newsletter')
    ...
    models = {
        ...
        'localsite.eventdatepricemap': {
            'Meta': {'unique_together': "(('eventdate', 'price'),)", 'object_name': 'EventDatePriceMap'},
            'eventdate': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'maps_by_price'", 'to': "orm['localsite.EventDate']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'map': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
