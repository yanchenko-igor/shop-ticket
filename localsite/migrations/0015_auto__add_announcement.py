...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('localsite_announcement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_date', self.gf('django.db.models.fields.DateField')(auto_now=True, auto_now_add=True, blank=True)),
            ('to_date', self.gf('django.db.models.fields.DateField')()),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(related_name='announcements', to=orm['localsite.Event'])),
        ))
        db.send_create_signal('localsite', ['Announcement'])


    def backwards(self, orm):
        
        # Deleting model 'Announcement'
        db.delete_table('localsite_announcement')
    ...
    models = {
        'localsite.announcement': {
            ...
            'from_date': ('django.db.models.fields.DateField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
