...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Event.min_price'
        db.add_column('localsite_event', 'min_price', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Event.max_price'
        db.add_column('localsite_event', 'max_price', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Event.min_date'
        db.add_column('localsite_event', 'min_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)

        # Adding field 'Event.max_date'
        db.add_column('localsite_event', 'max_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.min_price'
        db.delete_column('localsite_event', 'min_price')

        # Deleting field 'Event.max_price'
        db.delete_column('localsite_event', 'max_price')

        # Deleting field 'Event.min_date'
        db.delete_column('localsite_event', 'min_date')

        # Deleting field 'Event.max_date'
        db.delete_column('localsite_event', 'max_date')
