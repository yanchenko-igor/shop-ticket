...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SeatGroup'
        db.create_table('localsite_seatgroup', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('section', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('price', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('localsite', ['SeatGroup'])

        # Deleting field 'SeatLocation.sec'
        db.delete_column('localsite_seatlocation', 'sec')

        # Adding field 'SeatLocation.group'
        db.add_column('localsite_seatlocation', 'group', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='seats', to=orm['localsite.SeatGroup']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'SeatGroup'
        db.delete_table('localsite_seatgroup')

        # Adding field 'SeatLocation.sec'
        db.add_column('localsite_seatlocation', 'sec', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)

        # Deleting field 'SeatLocation.group'
        db.delete_column('localsite_seatlocation', 'group_id')
