...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Announcement.text'
        db.add_column('localsite_announcement', 'text', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Announcement.text'
        db.delete_column('localsite_announcement', 'text')
