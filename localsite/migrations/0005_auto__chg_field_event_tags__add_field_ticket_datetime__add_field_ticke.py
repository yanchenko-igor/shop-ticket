...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Event.tags'
        db.alter_column('localsite_event', 'tags', self.gf('tagging.fields.TagField')())

        # Adding field 'Ticket.datetime'
        db.add_column('localsite_ticket', 'datetime', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='tickets', to=orm['localsite.EventDate']), keep_default=False)

        # Adding field 'Ticket.seat'
        db.add_column('localsite_ticket', 'seat', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['localsite.SeatLocation']), keep_default=False)


    def backwards(self, orm):
        
        # Changing field 'Event.tags'
        db.alter_column('localsite_event', 'tags', self.gf('tagging.fields.TagField')(max_length=255))

        # Deleting field 'Ticket.datetime'
        db.delete_column('localsite_ticket', 'datetime_id')

        # Deleting field 'Ticket.seat'
        db.delete_column('localsite_ticket', 'seat_id')
