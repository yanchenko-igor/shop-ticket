...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Announcement.from_date'
        db.delete_column('localsite_announcement', 'from_date')

        # Deleting field 'Announcement.to_date'
        db.delete_column('localsite_announcement', 'to_date')

        # Adding field 'Announcement.begin'
        db.add_column('localsite_announcement', 'begin', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Announcement.end'
        db.add_column('localsite_announcement', 'end', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Announcement.from_date'
        raise RuntimeError("Cannot reverse this migration. 'Announcement.from_date' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Announcement.to_date'
        raise RuntimeError("Cannot reverse this migration. 'Announcement.to_date' and its values cannot be restored.")

        # Deleting field 'Announcement.begin'
        db.delete_column('localsite_announcement', 'begin')

        # Deleting field 'Announcement.end'
        db.delete_column('localsite_announcement', 'end')
    ...
    models = {
        ...
        'localsite.seatlocation': {
            'Meta': {'ordering': "['group', 'row', 'col']", 'unique_together': "(('hallscheme', 'group', 'row', 'col'),)", 'object_name': 'SeatLocation'},
