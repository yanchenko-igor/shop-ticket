...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EventDatePriceMap'
        db.create_table('localsite_eventdatepricemap', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('price', self.gf('django.db.models.fields.IntegerField')()),
            ('eventdate', self.gf('django.db.models.fields.related.ForeignKey')(related_name='maps_by_price', to=orm['localsite.EventDate'])),
            ('map', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('localsite', ['EventDatePriceMap'])


    def backwards(self, orm):
        
        # Deleting model 'EventDatePriceMap'
        db.delete_table('localsite_eventdatepricemap')
    ...
    models = {
        ...
        'localsite.eventdatepricemap': {
            'Meta': {'object_name': 'EventDatePriceMap'},
