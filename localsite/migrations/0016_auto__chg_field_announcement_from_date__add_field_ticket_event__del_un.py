...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Announcement.from_date'
        db.alter_column('localsite_announcement', 'from_date', self.gf('django.db.models.fields.DateField')())

        # Adding field 'Ticket.event'
        db.add_column('localsite_ticket', 'event', self.gf('django.db.models.fields.related.ForeignKey')(default='', related_name='tickets', to=orm['localsite.Event']), keep_default=False)

        # Adding unique constraint on 'Ticket', fields ['seat', 'event', 'datetime']
        db.create_unique('localsite_ticket', ['seat_id', 'event_id', 'datetime_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Ticket', fields ['seat', 'event', 'datetime']
        db.delete_unique('localsite_ticket', ['seat_id', 'event_id', 'datetime_id'])

        # Changing field 'Announcement.from_date'
        db.alter_column('localsite_announcement', 'from_date', self.gf('django.db.models.fields.DateField')(auto_now=True, auto_now_add=True))

        # Deleting field 'Ticket.event'
        db.delete_column('localsite_ticket', 'event_id')
    ...
    models = {
        ...
        'localsite.hallscheme': {
            'Meta': {'unique_together': "(('name', 'hall'),)", 'object_name': 'HallScheme'},
        ...
        'localsite.ticket': {
            'Meta': {'unique_together': "(('product', 'datetime', 'seat'), ('event', 'datetime', 'seat'))", 'object_name': 'Ticket'},
