...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('localsite_event', 'tags', self.gf('tagging.fields.TagField')(default='', max_length=255, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Event.tags'
        db.delete_column('localsite_event', 'tags')
