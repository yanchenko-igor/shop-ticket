...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'HallScheme', fields ['name', 'hall']
        db.create_unique('localsite_hallscheme', ['name', 'hall_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'HallScheme', fields ['name', 'hall']
        db.delete_unique('localsite_hallscheme', ['name', 'hall_id'])
