...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'City'
        db.create_table('localsite_city', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('city', self.gf('django.db.models.fields.CharField')(max_length=25)),
        ))
        db.send_create_signal('localsite', ['City'])

        # Renaming column for 'Hall.city' to match new field type.
        db.rename_column('localsite_hall', 'city', 'city_id')
        # Changing field 'Hall.city'
        db.alter_column('localsite_hall', 'city_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['localsite.City']))

        # Adding index on 'Hall', fields ['city']
        db.create_index('localsite_hall', ['city_id'])


    def backwards(self, orm):
        
        # Removing index on 'Hall', fields ['city']
        db.delete_index('localsite_hall', ['city_id'])

        # Deleting model 'City'
        db.delete_table('localsite_city')

        # Renaming column for 'Hall.city' to match new field type.
        db.rename_column('localsite_hall', 'city_id', 'city')
        # Changing field 'Hall.city'
        db.alter_column('localsite_hall', 'city', self.gf('django.db.models.fields.CharField')(max_length=25))
